    ...
    <div className="min-h-screen bg-background text-foreground flex">
      ...
      <aside className="w-64 border-r border-border bg-card p-4 flex flex-col">
        ...
        <nav className="flex-1 space-y-2">
          <Link
            href="/profile"
            className={`flex items-center space-x-2 px-4 py-2 rounded-lg transition-colors ${pathname === "/profile" ? "bg-primary/10 text-primary" : "hover:bg-accent hover:text-accent-foreground"}`}
          >
          ...
          <Link
            ...
            className={`flex items-center space-x-2 px-4 py-2 rounded-lg transition-colors ${pathname === "/settings/agents" ? "bg-primary/10 text-primary" : "hover:bg-accent hover:text-accent-foreground"}`}
          >
